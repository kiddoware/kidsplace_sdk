...
public class KPUtility {
	 ...
	 * @param Context: Android activity from where check needs to be made
	 ...
	 * @param markeplaceName:: Use KPUtility.GOOGLE_MARKET or KPUtility.AMAZON_MARKET to indicate where user should be directed
	 * to upgrade/installed Kids Place if they do not have the correct KP version installed. Currently only Google and Amazon 
	 * app stores are supported.  
	 * @throws Exception
	 */
